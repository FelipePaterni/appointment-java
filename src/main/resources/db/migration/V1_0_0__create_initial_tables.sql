...
create table tbl_professional (active boolean, person_id bigint not null, primary key (person_id)); 
create table tbl_role (id bigint generated by default as identity, role varchar(255) check ((role in ('ROLE_ADMIN','ROLE_OPERATOR'))), primary key (id)); 
...
create table tbl_user_role (role_id bigint not null, user_id bigint not null, primary key (role_id, user_id)); 
